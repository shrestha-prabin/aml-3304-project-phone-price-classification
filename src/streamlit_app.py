...
from web_search import chat, web_search
...
user_query = st.text_input(
    "Enter your query about the phone selection:",
    placeholder="e.g., Which phone should I buy?",
)
ask = st.button("Submit")

if user_query and ask:
    with st.spinner("Loading..."):
        response = chat({**input_vals, "user_query": user_query})
